...
This chapter uses the brms package to develop and evaluate Bayesian E~max~ regression models with and without covariates. It discusses models for continuous response data and binary response data. 
...
Two simulated data sets are used in this chapter. Both data sets include three continuous-valued covariates in addition to the exposure variable. In one data set the response is continuous, in the other it is binary-valued. 
